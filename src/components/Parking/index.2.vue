<template>
  <div id="people" class="container">
    ...
    <div class="alphabet-filter">
      ...
      <button class="btn btn-default" :class="{active:letter==selectedLetter}" v-for="letter in letters" v-bind:key="letter" @click="alphabetFilter(letter)">{{letter}}</button>
    ...
    <h4>Want to use the pagination component independently? Use
      <a target="_blank" href="https://www.npmjs.com/package/v-pagination">v-pagination</a>
    </h4>
  </div>
</template>
